...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-hero':    'radial-gradient(ellipse 100% 80% at 50% -5%, rgba(224,122,58,0.08) 0%, transparent 70%)',
        'gradient-card':    'linear-gradient(135deg, rgba(255,255,255,0.03) 0%, transparent 100%)',
        'gradient-cta':     'linear-gradient(135deg, #E07A3A 0%, #D97706 100%)',
        'gradient-mesh':    'radial-gradient(at 40% 20%, rgba(224,122,58,0.06) 0px, transparent 50%)',
        'gradient-swarm':   'linear-gradient(180deg, rgba(224,122,58,0.04) 0%, transparent 100%)',
